            ...
            <div class="row">
              <div class="col-md-8">
                <div class="panel-heading">
                  <h3 class="panel-title font-weight-bold">Daftar Buku Non-Tematik</h3>
                  <br>
              ...
              <div class="col-md-4">
                <form class="navbar-form navbar-left" action='/daftarbuku/nontematik' method='get'>
                  ...
                  <tbody>
                    ...
                    @foreach($data_buku as $buku)
                      <tr>
                        ...
                        <td><a href="#" class="jumlah" data-type="text" data-pk="{{$buku -> id}}" data-url="/api/buku/{{$buku -> id}}/editjumlah" data-title="Masukkan Nilai">{{$buku -> jumlah}}</a></td>
                        <td>
                        @if($buku -> jumlah != 0)
